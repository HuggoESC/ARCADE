...
ARCADE: raylib
ifneq (,$(ARCADE_config))
	@echo "==== Building ARCADE ($(ARCADE_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f ARCADE.make config=$(ARCADE_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f ARCADE.make clean
